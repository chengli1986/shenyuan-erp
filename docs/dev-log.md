# 项目开发记录
  ...
  - API地址：http://<SERVER_IP>:8000 (公网连接)
  - 使用场景：生产部署、演示展示
  ...
  **前端API调用修正**：
  ...
  ### 问题描述
  **症状**：用户登录成功后，主React应用在http://<SERVER_IP>:3000/出现无限加载
  ...
  **访问地址**：http://localhost:3000 或 http://<SERVER_IP>:3000
