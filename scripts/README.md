...
| `start-erp-prod.sh` | 生产启动 | serve静态服务器 | 8080 | 18.218.95.233:8000 | 生产演示 |
...
2. **访问系统**：
   - 开发模式：http://18.218.95.233:3000
   - 生产模式：http://18.218.95.233:8080
   - API文档：http://18.218.95.233:8000/docs
